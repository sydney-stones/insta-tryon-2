...
/**
 * Standalone Nicholas K demo page — pre-made example for sales calls.
...
export const NICHOLASK_PRODUCTS: Record<string, DemoProduct> = {
  'jump-skirt': {
    id: 80,
    name: 'Jump Skirt',
    brand: 'NICHOLAS K',
    ...
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    gallerySrcs: [
      '/result-images/nicholask/JumpSkirt/NicholasK-S-356E-SleevelessRouxShirt-Brick-SK-082-JumpSkirt-Brick-01.webp',
      '/result-images/nicholask/JumpSkirt/NicholasK-S-356E-SleevelessRouxShirt-Brick-SK-082-JumpSkirt-Brick-02.webp',
      '/result-images/nicholask/JumpSkirt/NicholasK-S-356E-SleevelessRouxShirt-Brick-SK-082-JumpSkirt-Brick-1.webp',
    ],
    faceSrc: '/result-images/siennaface-new.png',
    bodySrc: '/result-images/siennabody--new.JPG',
    afterSrc: '/result-images/nicholask/JumpSkirt/NicholasK-S-356E-SleevelessRouxShirt-Brick-SK-082-JumpSkirt-Brick-1_NicholasK-S-356E-SleevelessRouxShirt-Brick-SK-082-Ju.jpeg',
    description: 'The Jump Skirt in brick. A utility-meets-fashion silhouette crafted with Nicholas K\'s signature relaxed precision — drapes beautifully, moves with you.',
    colourLabel: 'Brick',
    swatchColor: '#8B3A2A',
  },
  'trench-coat-dress': {
    id: 81,
    name: 'Trench Coat Dress',
    brand: 'NICHOLAS K',
    price: '£1,274',
    category: 'Dresses',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    gallerySrcs: [
      '/result-images/nicholask/TrenchCoatDress/NicholasK-SD-665A-TrenchDress-Black--01.webp',
      '/result-images/nicholask/TrenchCoatDress/NicholasK-SD-665A-TrenchDress-Black--02.webp',
      '/result-images/nicholask/TrenchCoatDress/NicholasK-SD-665A-TrenchDress-Black--03.webp',
      '/result-images/nicholask/TrenchCoatDress/NicholasK-SD-665A-TrenchDress-Black--04.webp',
    ],
    faceSrc: '/result-images/siennaface-new.png',
    bodySrc: '/result-images/siennabody--new.JPG',
    afterSrc: '/result-images/nicholask/TrenchCoatDress/NicholasK-SD-665A-TrenchDress-Black--01_NicholasK-SD-665A-TrenchDress-Black--02_NicholasK-SD-665A-TrenchDress-Black--03_.jpeg',
    description: 'The Trench Coat Dress in black. A masterclass in elevated tailoring — the trench\'s structure reimagined as a full-length dress for effortless, refined dressing.',
    colourLabel: 'Black',
    swatchColor: '#1a1a1a',
  },
  'flower-district-earrings': {
    id: 83,
    ...
    sizes: ['One Size'],
    gallerySrcs: [
      '/result-images/nicholask/Flower District Earrings/NicholasK-SD-339E-RueJumper-Taupe-01.webp',
      '/result-images/nicholask/Flower District Earrings/NicholasK-SD-339E-RueJumper-Taupe-02.webp',
      '/result-images/nicholask/Flower District Earrings/NicholasK-SD-339E-RueJumper-Taupe-04_1200x.webp',
    ],
    faceSrc: '/result-images/siennaface-new.png',
    bodySrc: '/result-images/siennabody--new.JPG',
    afterSrc: '/result-images/nicholask/Flower District Earrings/NicholasK-SD-339E-RueJumper-Taupe-01_NicholasK-SD-339E-RueJumper-Taupe-04_1200x.jpeg',
    description: 'The Flower District Earrings. Statement jewellery with a distinctly wearable sensibility — sculptural, considered, and made to be noticed.',
    colourLabel: 'Taupe',
    swatchColor: '#B5A89A',
  },
  'jade-jumpsuit': {
    ...
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    gallerySrcs: [
      '/result-images/nicholask/JadeJumpsuit/J-013D-JadeJumpsuit-GunmetalFern-01.webp',
      '/result-images/nicholask/JadeJumpsuit/J-013D-JadeJumpsuit-GunmetalFern-02.webp',
      '/result-images/nicholask/JadeJumpsuit/J-013D-JadeJumpsuit-GunmetalFern-03.webp',
      '/result-images/nicholask/JadeJumpsuit/J-013D-JadeJumpsuit-GunmetalFern-05.webp',
    ],
    faceSrc: '/result-images/siennaface-new.png',
    bodySrc: '/result-images/siennabody--new.JPG',
    afterSrc: '/result-images/nicholask/JadeJumpsuit/J-013D-JadeJumpsuit-GunmetalFern-01_J-013D-JadeJumpsuit-GunmetalFern-02_J-013D-JadeJumpsuit-GunmetalFern-03_J-013D-JadeJ.jpeg',
    description: 'The Jade Jumpsuit in gunmetal fern. A deeply wearable one-piece with an earthy, complex tone — the kind of piece that reads as effortless whatever the occasion.',
    colourLabel: 'Gunmetal Fern',
    swatchColor: '#4A5240',
  },
};
...
function isBodyUploaded(s: AnimationState) { return ['body_uploaded','loading','result'].includes(s); }
...
interface NicholasKDemoPageProps {
  productSlug: keyof typeof NICHOLASK_PRODUCTS;
}

const NicholasKDemoPage: React.FC<NicholasKDemoPageProps> = ({ productSlug }) => {
  const product = NICHOLASK_PRODUCTS[productSlug];
  ...
  const handleTouchEnd = () => {
    if (touchStartX.current - touchEndX.current > 50)
      setActiveGalleryIndex(prev => prev === product.gallerySrcs.length - 1 ? 0 : prev + 1);
    if (touchEndX.current - touchStartX.current > 50)
      setActiveGalleryIndex(prev => prev === 0 ? product.gallerySrcs.length - 1 : prev - 1);
  };
      ...
      <header style={{ borderBottom: '1px solid #e5e5e5', position: 'sticky', top: 0, backgroundColor: '#fff', zIndex: 40 }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '60px' }}>
          <nav style={{ display: 'flex', gap: '24px', fontSize: '11px', letterSpacing: '0.15em', fontWeight: 500 }}>
            {['NEW IN','DRESSES','JUMPSUITS','OUTERWEAR'].map(n => (
              <span key={n} style={{ color: '#aaa' }}>{n}</span>
            ))}
          </nav>
      ...
      {isMobile ? (
        <div style={{ padding: '0 0 64px' }}>
          <div style={{ padding: '0 20px 12px' }}>
            <h1 style={{ fontSize: '14px', fontWeight: 400, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#111', margin: 0 }}>{product.name}</h1>
          </div>
            ...
            {product.gallerySrcs.length > 1 && (
              <div style={{ position: 'absolute', bottom: '10px', left: 0, right: 0, display: 'flex', gap: '6px', justifyContent: 'center' }}>
                {product.gallerySrcs.map((_, i) => (
                  <button key={i} onClick={() => setActiveGalleryIndex(i)} style={{ width: '6px', height: '6px', borderRadius: '50%', border: 'none', cursor: 'pointer', padding: 0, backgroundColor: activeGalleryIndex === i ? '#fff' : 'rgba(255,255,255,0.5)' }} />
                ))}
              </div>
            )}
          </div>
          ...
          <div style={{ padding: '16px 20px 0' }}>
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
                {product.sizes.map(s => (
                  <button key={s} onClick={() => setSelectedSize(s)} style={{ padding: '7px 12px', fontSize: '13px', fontWeight: 500, cursor: 'pointer', border: selectedSize === s ? '2px solid #111' : '1px solid #ccc', backgroundColor: selectedSize === s ? '#111' : '#fff', color: selectedSize === s ? '#fff' : '#111' }}>{s}</button>
                ))}
              </div>
            </div>

            <button ref={tryOnButtonRef} onClick={() => { if (!animationActive) setAnimationActive(true); }}
              style={{ width: '100%', padding: '16px', fontSize: '12px', fontWeight: 500, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#fff', backgroundColor: '#2C2C2C', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', marginBottom: '8px', boxShadow: '0 0 20px rgba(44,44,44,0.4)' }}
            >
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 24px 64px', display: 'grid', gridTemplateColumns: '1fr 460px', gap: '48px', alignItems: 'start' }}>
            ...
            {product.gallerySrcs.length > 1 && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', width: '80px', flexShrink: 0 }}>
                {product.gallerySrcs.map((src, i) => (
                  <button key={i} onClick={() => setActiveGalleryIndex(i)} style={{ width: '80px', height: '100px', padding: 0, border: 'none', cursor: 'pointer', outline: activeGalleryIndex === i ? '2px solid #111' : '1px solid #e5e5e5', outlineOffset: '-1px', overflow: 'hidden', backgroundColor: '#f5f5f5', flexShrink: 0 }}>
          ...
          <div style={{ paddingTop: '8px' }}>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
                {product.sizes.map(s => (
                  <button key={s} onClick={() => setSelectedSize(s)} style={{ padding: '8px 14px', fontSize: '13px', fontWeight: 500, cursor: 'pointer', border: selectedSize === s ? '2px solid #111' : '1px solid #ccc', backgroundColor: selectedSize === s ? '#111' : '#fff', color: selectedSize === s ? '#fff' : '#111' }}>{s}</button>
                ))}
              </div>
            </div>
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '32px', flex: 1 }}>
                        <div style={{ padding: '24px 24px 0' }}>
                          <p style={{ fontSize: '30px', fontWeight: 400, textTransform: 'uppercase', color: '#101828', lineHeight: '36px' }}>TRY IT ON, VIRTUALLY</p>
                        </div>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0px' }}>
                          ...
                          <div ref={faceUploadRef} style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', padding: '16px', gap: '20px', backgroundColor: '#F9FAFB', borderBottom: '1px solid #D1D5DC', cursor: 'pointer', marginLeft: '24px', marginRight: '24px' }}>
                            {isFaceUploaded(animState) ? (
                              ...
                              <div style={{ width: '40px', height: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none"><circle cx="20" cy="15" r="7" stroke="#101828" strokeWidth="1.5" fill="none" /><path d="M8 36c0-6.627 5.373-12 12-12s12 5.373 12 12" stroke="#101828" strokeWidth="1.5" fill="none" /></svg>
                              </div>
                            )}
                            <div>
                              <p style={{ fontSize: '16px', fontWeight: 500, color: '#101828', marginBottom: '0px', lineHeight: '24px' }}>{isFaceUploaded(animState) ? 'Face photo uploaded' : 'Upload your photo here'}</p>
                              <p style={{ fontSize: '14px', color: '#6A7282', lineHeight: '20px' }}>{isFaceUploaded(animState) ? 'Tap to change' : 'Format: png, jpg, heic & Max file size: 25 MB'}</p>
                            </div>
                          </div>
                          ...
                          <div ref={bodyUploadRef} style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', padding: '16px', gap: '20px', backgroundColor: '#F9FAFB', borderBottom: '1px solid #D1D5DC', cursor: 'pointer', marginLeft: '24px', marginRight: '24px' }}>
                            ...
                            <div>
                              <p style={{ fontSize: '16px', fontWeight: 500, color: '#101828', marginBottom: '0px', lineHeight: '24px' }}>{isBodyUploaded(animState) ? 'Full body photo uploaded' : 'Upload your photo here'}</p>
                              <p style={{ fontSize: '14px', color: '#6A7282', lineHeight: '20px' }}>{isBodyUploaded(animState) ? 'Tap to change' : 'Format: png, jpg, heic & Max file size: 25 MB'}</p>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              {isResultState(animState) && (
                <div style={{ fontFamily: "'Jost', sans-serif", display: 'flex', flexDirection: 'column' }}>
                  <div style={{ display: 'flex', alignItems: 'center', height: '48px', padding: '0 16px', borderBottom: '1px solid #D1D5DC', gap: '12px', flexShrink: 0 }}>
                    ...
                    <button onClick={() => { setAnimationActive(false); setTimeout(() => setAnimationActive(true), 50); }} style={{ width: '32px', height: '32px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'none', border: '1px solid #D1D5DC', cursor: 'pointer', flexShrink: 0 }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'center', padding: '20px', backgroundColor: '#F9FAFB', overflowY: 'auto', maxHeight: '75vh' }}>
                    <div style={{ width: '341px', maxWidth: '100%', backgroundColor: '#fff', border: '1px solid #E5E7EB' }}>
                      <button onClick={() => setFullscreenImage(true)} style={{ display: 'block', width: '100%', background: 'none', border: 'none', padding: 0, cursor: 'zoom-in' }}>
...
export default NicholasKDemoPage;
