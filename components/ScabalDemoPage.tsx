...
/**
 * Standalone Scabal demo pages — identical widget/workflow to ResultsPage,
 * but each product lives at its own shareable URL with no close button
 * (no parent grid to return to).
 */
...
export const SCABAL_PRODUCTS: Record<string, DemoProduct> = {
  'wool-suit': {
    id: 21,
...
interface ScabalDemoPageProps {
  productSlug: 'wool-suit' | 'tailored-jacket';
}

const ScabalDemoPage: React.FC<ScabalDemoPageProps> = ({ productSlug }) => {
  const product = SCABAL_PRODUCTS[productSlug];
                ...
                <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '0px' }}>
                      ...
                      {/* No close button — this is a standalone page */}
