 ...
 * All demos use Sienna (female) customer images.
 */
...
export const BROWNIE_PRODUCTS: Record<string, DemoProduct> = {
  'multi-ruffle-skirt': {
    ...
    category: 'Skirts',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    productSrc: '/result-images/brownie4.webp',
    productLabel: 'Product: Multi-ruffle Shiny Skirt',
  ...
  'satin-jacquard-top': {
    ...
    category: 'Tops',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    productSrc: '/result-images/brownie1.webp',
    productLabel: 'Product: Satin Jacquard Top',
    faceSrc: '/result-images/siennaface-new.png',
    bodySrc: '/result-images/siennaneutral--new.JPG',
...
const BrownieDemoPage: React.FC<BrownieDemoPageProps> = ({ productSlug }) => {
  ...
  return (
    <div className="min-h-screen bg-white overflow-auto">
      ...
      {/* Store Header — branded as Brownie */}
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14">
            <nav className="hidden md:flex items-center gap-6 text-[11px] tracking-[0.15em] font-medium">
              ...
              <span className="text-gray-400">SKIRTS</span>
            </nav>
