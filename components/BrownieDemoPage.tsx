...
/**
 * Standalone Brownie demo pages — pre-made examples for sales calls.
...
export const BROWNIE_PRODUCTS: Record<string, DemoProduct> = {
  'multi-ruffle-skirt': {
    id: 50,
    name: 'Multi-ruffle Shiny Skirt',
    brand: 'brownie',
    price: '€79,90',
    category: 'Skirts',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    gallerySrcs: [
      '/result-images/brownie4.webp',
      '/result-images/brownie5.webp',
      '/result-images/brownie6.webp',
    ],
    faceSrc: '/result-images/siennaface-new.png',
    bodySrc: '/result-images/siennabody--new.JPG',
    afterSrc: '/result-images/brownie4-nb2-2k-tryon.png',
    description: 'A bold statement skirt with cascading ruffles in a lustrous shiny fabric. Designed for those who dress with intention.',
  },
  'satin-jacquard-top': {
    id: 51,
    name: 'Satin Jacquard Top',
    brand: 'brownie',
    price: '€45,90',
    category: 'Tops',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    gallerySrcs: [
      '/result-images/brownie1.webp',
      '/result-images/brownie2.webp',
      '/result-images/brownie3.webp',
    ],
    faceSrc: '/result-images/siennaface-new.png',
    bodySrc: '/result-images/siennabody--new.JPG',
...
interface BrownieDemoPageProps {
  productSlug: keyof typeof BROWNIE_PRODUCTS;
}

const BrownieDemoPage: React.FC<BrownieDemoPageProps> = ({ productSlug }) => {
  const product = BROWNIE_PRODUCTS[productSlug];
      ...
      <header style={{ borderBottom: '1px solid #e5e5e5', position: 'sticky', top: 0, backgroundColor: '#fff', zIndex: 40 }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '60px' }}>
          <nav style={{ display: 'flex', gap: '24px', fontSize: '11px', letterSpacing: '0.15em', fontWeight: 500 }}>
            {['NEW IN','DRESSES','TOPS','SKIRTS'].map(n => (
              <span key={n} style={{ color: '#aaa' }}>{n}</span>
            ))}
          </nav>
          <span style={{ position: 'absolute', left: '50%', transform: 'translateX(-50%)', fontSize: '20px', fontWeight: 300, letterSpacing: '0.05em', color: '#111' }}>
            brownie
          </span>
          <div />
        </div>
      ...
      {isMobile ? (
        <div style={{ padding: '0 0 64px' }}>
          ...
          <div style={{ padding: '0 20px 12px' }}>
            <h1 style={{ fontSize: '14px', fontWeight: 400, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#111', margin: 0 }}>
              {product.name}
            </h1>
          </div>
          ...
          <div style={{ padding: '16px 20px 0' }}>
            ...
            <button
              ...
              style={{
                width: '100%', padding: '16px', fontSize: '12px', fontWeight: 500,
                letterSpacing: '0.15em', textTransform: 'uppercase', color: '#fff',
                backgroundColor: '#444833', border: 'none', cursor: 'pointer',
                display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px',
                marginBottom: '8px', boxShadow: '0 0 20px rgba(68,72,51,0.4)',
              }}
            >
            ...
            <button style={{
              width: '100%', padding: '16px', fontSize: '12px', fontWeight: 500,
              letterSpacing: '0.15em', textTransform: 'uppercase', color: '#111',
              backgroundColor: '#fff', border: '1px solid #111', cursor: 'default', marginBottom: '20px',
            }}>ADD TO BAG</button>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 24px 64px', display: 'grid', gridTemplateColumns: '1fr 460px', gap: '48px', alignItems: 'start' }}>
          ...
          <div style={{ paddingTop: '8px' }}>
            <h1 style={{ fontSize: '14px', fontWeight: 400, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#111', margin: '0 0 16px 0' }}>
              {product.name}
            </h1>
              ...
              {isLoadingState(animState) && (
                <div style={{ fontFamily: "'Jost', sans-serif" }}>
                  ...
                  <div style={{ padding: '48px 32px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '360px', textAlign: 'center' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '6px', padding: '0 8px', height: '29.83px', backgroundColor: '#F3F4F6', border: '1px solid #E5E7EB', justifyContent: 'center' }}>
                      <span style={{ fontSize: '11px', fontWeight: 500, color: '#101828', fontFamily: "'Jost', sans-serif" }}>Size: {selectedSize}</span>
                      <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#6A7282" strokeWidth="2"><path d="M6 9l6 6 6-6"/></svg>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'center', padding: '20px', backgroundColor: '#F9FAFB', overflowY: 'auto', maxHeight: '75vh' }}>
                    <div style={{ width: '341px', maxWidth: '100%', backgroundColor: '#fff', border: '1px solid #E5E7EB' }}>
                      ...
                      <div style={{ padding: '12px 12px 0' }}>
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '6px', backgroundColor: '#fff', border: '1px solid #E5E7EB', padding: '0 12px', height: '44px', boxSizing: 'border-box' }}>
...
export default BrownieDemoPage;
