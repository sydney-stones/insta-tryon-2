...
export const MR_BUTTON_PRODUCTS: Record<string, DemoProduct> = {
  'grey-shacket': {
    id: 80,
    name: 'Grey Solid Regular Fit Shacket',
    sku: 'SKT1012-GREY-S',
    brand: 'Mr Button',
    price: '₹2,937',
    originalPrice: '₹4,195',
    ...
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    gallerySrcs: [
      '/result-images/mrbutton.webp',
      '/result-images/mrbutton2.webp',
      '/result-images/mrbutton3.webp',
    ],
...
interface MrButtonDemoPageProps {
  productSlug: keyof typeof MR_BUTTON_PRODUCTS;
}

const MrButtonDemoPage: React.FC<MrButtonDemoPageProps> = ({ productSlug }) => {
  const product = MR_BUTTON_PRODUCTS[productSlug];
    ...
    <div className="min-h-screen bg-white overflow-auto">
      ...
      <header style={{ borderBottom: '1px solid #e5e5e5', position: 'sticky', top: 0, backgroundColor: '#fff', zIndex: 40 }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '60px' }}>
          <nav style={{ display: 'flex', gap: '24px', fontSize: '11px', letterSpacing: '0.12em', fontWeight: 500 }}>
            {['NEW IN','SHIRTS','JACKETS','TROUSERS'].map(n => (
              <span key={n} style={{ color: '#aaa' }}>{n}</span>
            ))}
          </nav>
          <span style={{ position: 'absolute', left: '50%', transform: 'translateX(-50%)', fontSize: '20px', fontWeight: 600, letterSpacing: '0.04em', color: '#111' }}>
            Mr Button
          </span>
          <div />
        </div>
      ...
      {isMobile ? (
        <div style={{ padding: '0 0 64px' }}>
          <div style={{ padding: '0 20px 12px' }}>
            <h1 style={{ fontSize: '15px', fontWeight: 600, letterSpacing: '0.02em', color: '#111', margin: '0 0 4px 0' }}>{product.name}</h1>
            <p style={{ fontSize: '11px', color: '#999', margin: 0 }}>SKU: {product.sku}</p>
          </div>
          ...
          <div style={{ padding: '16px 20px 0' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
              ...
              <span style={{ fontSize: '11px', fontWeight: 700, color: '#16a34a', backgroundColor: '#f0fdf4', padding: '2px 6px', borderRadius: '3px' }}>30% OFF</span>
            </div>
            ...
            <button ref={tryOnButtonRef} onClick={() => { if (!animationActive) setAnimationActive(true); }}
              style={{ width: '100%', padding: '16px', fontSize: '12px', fontWeight: 500, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#fff', backgroundColor: '#444833', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', marginBottom: '8px', boxShadow: '0 0 20px rgba(68,72,51,0.4)' }}
            >
            ...
            <button style={{ width: '100%', padding: '16px', fontSize: '13px', fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase', color: '#fff', backgroundColor: '#111', border: 'none', cursor: 'default', marginBottom: '20px' }}>ADD TO CART</button>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 24px 64px', display: 'grid', gridTemplateColumns: '1fr 460px', gap: '48px', alignItems: 'start' }}>
          ...
          <div style={{ paddingTop: '8px' }}>
            <h1 style={{ fontSize: '18px', fontWeight: 600, letterSpacing: '0.02em', color: '#111', margin: '0 0 4px 0' }}>{product.name}</h1>
            <p style={{ fontSize: '12px', color: '#999', margin: '0 0 16px 0' }}>SKU: {product.sku}</p>

            {/* Price */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px' }}>
              <span style={{ fontSize: '22px', fontWeight: 700, color: '#111' }}>{product.price}</span>
              <span style={{ fontSize: '14px', color: '#999', textDecoration: 'line-through' }}>{product.originalPrice}</span>
              <span style={{ fontSize: '12px', fontWeight: 700, color: '#16a34a', backgroundColor: '#f0fdf4', padding: '2px 8px', borderRadius: '3px' }}>30% OFF</span>
            </div>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <p style={{ fontSize: '12px', color: '#666', margin: '6px 0 0 0' }}>Model wears size {product.sizes[1]}.</p>
            </div>
...
export default MrButtonDemoPage;
