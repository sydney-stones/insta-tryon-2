...
/**
 * Standalone TBCO demo pages — identical widget/workflow to ScabalDemoPage,
 * branded as TBCO. All demos use Sienna (female) customer images.
 */
...
export const TBCO_PRODUCTS: Record<string, DemoProduct> = {
  'demo1': {
    id: 40,
    name: 'TBCO Dress',
    brand: 'TBCO',
    ...
    category: 'Dresses',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    productSrc: '/result-images/tbco1product.png',
    productLabel: 'Product: TBCO Dress',
    faceSrc: '/result-images/siennaface-new.png',
    bodySrc: '/result-images/siennabody--new.JPG',
    afterSrc: '/result-images/tbco1result.png',
    afterLabel: 'Try-On Result',
    description: 'A statement dress from TBCO. Effortlessly elegant with a refined silhouette designed for the modern woman.',
  },
  'demo2': {
    id: 41,
    name: 'TBCO Top',
    ...
    category: 'Tops',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    productSrc: '/result-images/tbco2product.png',
    productLabel: 'Product: TBCO Top',
    faceSrc: '/result-images/siennaface-new.png',
    bodySrc: '/result-images/siennabody--new.JPG',
    afterSrc: '/result-images/tbco2result.png',
    afterLabel: 'Try-On Result',
    description: 'A versatile top from TBCO, crafted with attention to detail and cut for a flattering fit.',
  },
  'demo3': {
    id: 42,
    name: 'TBCO Top II',
    ...
    category: 'Tops',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    productSrc: '/result-images/tbco3product.png',
    productLabel: 'Product: TBCO Top II',
    faceSrc: '/result-images/siennaface-new.png',
    bodySrc: '/result-images/siennabody--new.JPG',
    afterSrc: '/result-images/tbco3result.png',
    afterLabel: 'Try-On Result',
    description: 'A fresh take on TBCO\'s signature style. Clean cuts and quality fabric make this a wardrobe essential.',
  },
};
...
interface TbcoDemoPageProps {
  productSlug: keyof typeof TBCO_PRODUCTS;
}

const TbcoDemoPage: React.FC<TbcoDemoPageProps> = ({ productSlug }) => {
  const product = TBCO_PRODUCTS[productSlug];
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14">
            <nav className="hidden md:flex items-center gap-6 text-[11px] tracking-[0.15em] font-medium">
              ...
              <span className="text-gray-400">TROUSERS</span>
                ...
                <div style={{ fontFamily: "'Jost', sans-serif", display: 'flex', flexDirection: 'column' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'center', padding: '20px', backgroundColor: '#F9FAFB', overflowY: 'auto', maxHeight: '75vh' }}>
                    <div style={{ width: '341px', maxWidth: '100%', backgroundColor: '#fff', border: '1px solid #E5E7EB', position: 'relative' }}>
                      ...
                      >
                        <img src={product.afterSrc} alt={product.afterLabel} style={{ width: '100%', height: 'auto', objectFit: 'contain', display: 'block' }} />
                      </button>
      ...
      <AnimatePresence>
        {fullscreenImage && (
          ...
          >
            ...
            <motion.img
              src={product.afterSrc} alt={product.afterLabel}
