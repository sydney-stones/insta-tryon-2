...
export const KHANUMS_PRODUCTS: Record<string, DemoProduct> = {
  'kodil-dress-sage-green': {
    ...
    category: 'Dresses',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    productSrc: '/result-images/khanums1.webp',
    productLabel: 'Product: Kodil Dress - Sage Green',
...
const KhanumsDemoPage: React.FC<KhanumsDemoPageProps> = ({ productSlug }) => {
  ...
  return (
    <div className="min-h-screen bg-white overflow-auto">
      ...
      {/* Store Header — branded as Khanums */}
      <header className="border-b border-gray-200 sticky top-0 bg-white z-40">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14">
            ...
            <span className="absolute left-1/2 transform -translate-x-1/2 text-lg sm:text-xl tracking-[0.08em] font-light text-gray-900">
              KHANUMS
            </span>
