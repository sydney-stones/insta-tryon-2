...
interface HouseOfBraurProductPageProps {
  product: WardrobeItem;
  onTryOnClick: (product: WardrobeItem) => void;
}

const HouseOfBraurProductPage: React.FC<HouseOfBraurProductPageProps> = ({ product, onTryOnClick }) => {
  ...
  const mainProduct = {
    ...
    price: 65,
    image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/houseofbraur-jumper.png',
  ...
  const completeTheLookItems = [
    {
      ...
      price: 129.95,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/houseofbraur-trousers.png',
      shopUrl: 'https://go.shopmy.us/p-31709443',
    },
    {
      name: 'Men\'s Gant Mc Julien Sneakers',
      price: 140,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/houseofbraur-shoes.png',
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6 lg:gap-8 text-xs lg:text-sm tracking-wide">
              ...
              <Link to="/" className="hover:opacity-60 transition-opacity">HERITAGE</Link>
            </nav>
...
export default HouseOfBraurProductPage;
