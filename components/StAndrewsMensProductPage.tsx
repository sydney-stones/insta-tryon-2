...
interface StAndrewsMensProductPageProps {
  product: WardrobeItem;
  onTryOnClick: (product: WardrobeItem) => void;
}

const StAndrewsMensProductPage: React.FC<StAndrewsMensProductPageProps> = ({ product, onTryOnClick }) => {
  ...
  // Main product item (Fleece)
  const mainProduct = {
    name: '1/4 ZIP FLEECE',
    price: 45,
    image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/standrewsmens-fleece.png',
  ...
  const completeTheLookItems = [
    {
      ...
      price: 35,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/standrewsmens-trousers.png',
      shopUrl: 'https://go.shopmy.us/p-31710070',
    },
    {
      name: 'HOKA Cloud 6',
      price: 140,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/standrewsmens-shoes.png',
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6 lg:gap-8 text-xs lg:text-sm tracking-wide">
              ...
              <Link to="/" className="hover:opacity-60 transition-opacity">SPORT</Link>
            </nav>
...
export default StAndrewsMensProductPage;
