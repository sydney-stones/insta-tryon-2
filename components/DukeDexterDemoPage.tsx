...
export const DUKEDEXTER_PRODUCTS: Record<string, DemoProduct> = {
  'ny-sketch-oat-marl-short': {
    ...
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    gallerySrcs: [
      '/result-images/Duke + Dexter/NY Sketch Oat Marl Short/2603190000001600102_1000x.webp',
      '/result-images/Duke + Dexter/NY Sketch Oat Marl Short/DUKE110_1000x.webp',
      '/result-images/Duke + Dexter/NY Sketch Oat Marl Short/DUKE35_394df13b-d8b9-4e89-8483-3d077a9c907f_1000x.webp',
    ],
    faceSrc: '/result-images/siennaface-new.png',
    bodySrc: '/result-images/siennabody--new.JPG',
    afterSrc: '/result-images/Duke + Dexter/NY Sketch Oat Marl Short/2603190000001600102_1000x_DUKE110_1000x_Try-On.jpeg',
  ...
  'peso-mechanic-shirt': {
    ...
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    gallerySrcs: [
      '/result-images/Duke + Dexter/Peso Mechanic Shirt/1_ac6100e1-3415-44e2-8341-60d5cba66d80_1000x.webp',
      '/result-images/Duke + Dexter/Peso Mechanic Shirt/02_PESO_-_062_1000x.webp',
      '/result-images/Duke + Dexter/Peso Mechanic Shirt/02_PESO-015_1000x.webp',
    ],
    faceSrc: '/result-images/siennaface-new.png',
    bodySrc: '/result-images/siennabody--new.JPG',
    afterSrc: '/result-images/Duke + Dexter/Peso Mechanic Shirt/1_ac6100e1-3415-44e2-8341-60d5cba66d80_1000x_02_PESO_-_062_1000x_02_PESO-015_1000x_Try-On.jpeg',
  ...
  'dr-motocross-vintage-white-waffle-top': {
    ...
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    gallerySrcs: [
      '/result-images/Duke + Dexter/DR Motocross Vintage White Waffle Top/1_76d86ad7-c45b-47ac-8b3c-7a91a715a9a8_1000x.webp',
      '/result-images/Duke + Dexter/DR Motocross Vintage White Waffle Top/untitled-000376060001_1000x.webp',
    ],
    faceSrc: '/result-images/sydface.jpeg',
    bodySrc: '/result-images/sydbody--new.jpeg',
    afterSrc: '/result-images/Duke + Dexter/DR Motocross Vintage White Waffle Top/1_76d86ad7-c45b-47ac-8b3c-7a91a715a9a8_1000x_untitled-000376060001_1000x_Try-On.jpeg',
  ...
  'ny-sketch-washed-grey-waffle-top': {
    ...
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    gallerySrcs: [
      '/result-images/Duke + Dexter/NY Sketch Washed Grey Waffle Top /1_628e499e-1554-4858-ba82-cb097a852c4e_1000x.jpg',
    ],
    faceSrc: '/result-images/sydface.jpeg',
    bodySrc: '/result-images/sydbody--new.jpeg',
    afterSrc: '/result-images/Duke + Dexter/NY Sketch Washed Grey Waffle Top /1_628e499e-1554-4858-ba82-cb097a852c4e_1000x_Try-On.jpeg',
  ...
  'plus-duke-kiss-sneaker-womens': {
    ...
    gallerySrcs: [
      '/result-images/Duke + Dexter/Plus Duke Kiss Sneaker/DD-0325-1-Womens-9--GreyBG-LowRes_1000x.webp',
      '/result-images/Duke + Dexter/Plus Duke Kiss Sneaker/DD-0325-1-Womens-9-2-GreyBG-LowRes_1000x.webp',
      '/result-images/Duke + Dexter/Plus Duke Kiss Sneaker/DD-0325-1-Womens-9-4-GreyBG-LowRes_1000x.webp',
      '/result-images/Duke + Dexter/Plus Duke Kiss Sneaker/dd-ss25-540_1000x.webp',
    ],
    faceSrc: '/result-images/siennaface-new.png',
    bodySrc: '/result-images/siennabody--new.JPG',
    afterSrc: '/result-images/Duke + Dexter/Plus Duke Kiss Sneaker/DD-0325-1-Womens-9--GreyBG-LowRes_1000x_DD-0325-1-Womens-9-2-GreyBG-LowRes_1000x_DD-0325-1-Womens-9-4-GreyBG-L_Try-On (1).jpeg',
