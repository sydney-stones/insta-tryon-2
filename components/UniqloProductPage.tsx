  ...
  const completeTheLookItems = [
    {
      name: 'Hat',
      price: 24.90,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Festival_Of_Fashion/FOF-individualitems/Uniqlo/Uniqlo-Cap.png',
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-12">
        ...
        <ROICalculator defaultRevenue={500000} />
      </div>
