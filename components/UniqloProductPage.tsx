...
interface UniqloProductPageProps {
  product: WardrobeItem;
  onTryOnClick: (product: WardrobeItem) => void;
}

const UniqloProductPage: React.FC<UniqloProductPageProps> = ({ product, onTryOnClick }) => {
  const [selectedImageIndex, setSelectedImageIndex] = useState(0);
  const [showPurchaseModal, setShowPurchaseModal] = useState(false);
  const [monthlyRevenue, setMonthlyRevenue] = useState(15000000);
  const savedModel = getSavedModel();
  const touchStartX = useRef(0);
  const touchEndX = useRef(0);

  // Main product item (Poncho)
  const mainProduct = {
    name: 'Poncho',
    price: 49.90,
    image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Festival_Of_Fashion/FOF-individualitems/Uniqlo/Uniqlo-Poncho.png',
  ...
  const completeTheLookItems = [
    {
      name: 'Hat',
      price: 24.90,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Festival_Of_Fashion/FOF-individualitems/Uniqlo/Uniqlo-Hat.png',
    ...
    },
    {
      name: 'Gloves',
      price: 19.90,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Festival_Of_Fashion/FOF-individualitems/Uniqlo/Uniqlo-Gloves.png',
    ...
    },
    {
      name: 'Bag',
      price: 12.90,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Festival_Of_Fashion/FOF-individualitems/Uniqlo/Uniqlo-Bag.png',
    ...
    },
    {
      name: 'Trousers',
      price: 39.90,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Festival_Of_Fashion/FOF-individualitems/Uniqlo/Uniqlo-Trousers.png',
    ...
    },
    {
      ...
      brand: 'Grenson',
      price: 540,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Festival_Of_Fashion/FOF-individualitems/Uniqlo/Grensons-Arabella.png',
      shopUrl: 'https://go.shopmy.us/p-28351463',
      isUniqlo: false,
      affiliateCommission: 54
    }
  ];
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6 lg:gap-8 text-xs lg:text-sm tracking-wide">
              ...
              <Link to="/" className="hover:opacity-60 transition-opacity">KIDS</Link>
                  ...
                  <div key={index} className="group">
                    <a href={item.shopUrl} target="_blank" rel="noopener noreferrer" className="block relative">
                      <div className="relative aspect-[3/4] bg-gray-100 rounded-sm overflow-hidden mb-2">
                        ...
                        {!item.isUniqlo && item.affiliateCommission && (
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-8 sm:p-12">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="bg-white rounded-xl p-6">
                  <div className="text-sm font-medium text-gray-600 mb-2">Sales Uplift (+10%)</div>
...
export default UniqloProductPage;
