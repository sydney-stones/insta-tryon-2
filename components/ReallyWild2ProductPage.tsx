...
const ReallyWild2ProductPage: React.FC<ReallyWild2ProductPageProps> = ({ product, onTryOnClick }) => {
  ...
  // Main product item (Gilet)
  const mainProduct = {
    name: 'Windsor Tweed Country Waistcoat',
    price: 425,
    image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Festival_Of_Fashion/FOF-individualitems/Reallywild/reallywild2-gilet.png',
  ...
  const completeTheLookItems = [
    {
      ...
      price: 495,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Festival_Of_Fashion/FOF-individualitems/Reallywild/reallywild2-trousers.png',
    ...
    },
    {
      ...
      price: 175,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Festival_Of_Fashion/FOF-individualitems/Reallywild/reallywild2-jumper.png',
    ...
    },
    {
      ...
      price: 395,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Festival_Of_Fashion/FOF-individualitems/Reallywild/reallywild2-boots.png',
    ...
    },
    {
      ...
      price: 55,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Festival_Of_Fashion/FOF-individualitems/Reallywild/reallywild2-socks.png',
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_450px] xl:grid-cols-[1fr_500px] gap-6 lg:gap-12">
          ...
          <div className="relative bg-gray-100 rounded-sm overflow-hidden">
            ...
            {/* Thumbnail Gallery */}
            {productMedia.length > 1 && (
              <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 bg-white/80 backdrop-blur-sm p-2 rounded-lg">
                {productMedia.map((media, index) => (
                  <button
                    key={index}
                    onClick={() => setSelectedImageIndex(index)}
                    className={`w-12 h-12 sm:w-16 sm:h-16 rounded overflow-hidden bg-white transition-all ${
...
export default ReallyWild2ProductPage;
