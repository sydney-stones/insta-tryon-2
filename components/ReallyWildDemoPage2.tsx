...
const ReallyWildDemoPage2: React.FC = () => {
  ...
  const productImage = '/result-images/reallywild-3.png';
  const tryOnResultImage = '/result-images/reallywild3-tryon-1k.png';
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-3">
        <nav className="flex items-center gap-2 text-[11px] text-gray-500">
          ...
          <span>Knitwear</span>
          <span>/</span>
          <span className="text-gray-900">Fair Isle Knit Sweater</span>
        </nav>
      </div>
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] xl:grid-cols-[1fr_460px] gap-6 lg:gap-12">
          ...
          <div className="flex flex-col lg:pt-0">
            ...
            <p className="text-[12px] text-gray-500 mb-4">Olive / Multi</p>

            {/* Price */}
            <div className="mb-6">
              <span className="text-[14px] font-medium">£295</span>
            </div>

            {/* Color Swatches */}
            <div className="flex items-center gap-3 mb-6">
              <div className="w-6 h-6 rounded-full bg-[#5a6b4a] ring-2 ring-black ring-offset-2 cursor-pointer" />
              <div className="w-6 h-6 rounded-full bg-[#8b4a4a] cursor-pointer hover:ring-2 hover:ring-gray-400 hover:ring-offset-2 transition-all" />
              <div className="w-6 h-6 rounded-full bg-[#4a5a6b] cursor-pointer hover:ring-2 hover:ring-gray-400 hover:ring-offset-2 transition-all" />
            </div>
            ...
            <details className="border-t border-gray-200 py-4 group">
              ...
              <p className="mt-3 text-[11px] text-gray-500 leading-relaxed">
                A beautiful fair isle knit sweater in olive and multi-colour tones. This heritage-inspired piece features a traditional pattern with a modern relaxed fit. Crafted from soft lambswool for warmth and comfort.
              </p>
            </details>
            ...
            <details className="border-t border-gray-200 py-4 group">
              ...
              <p className="mt-3 text-[11px] text-gray-500 leading-relaxed">
                100% Lambswool. Crew neck. Ribbed cuffs and hem. Relaxed fit. Made in Scotland.
              </p>
            </details>
            ...
            <details className="border-t border-gray-200 py-4 group">
              ...
              <p className="mt-3 text-[11px] text-gray-500 leading-relaxed">
                Hand wash cold. Do not bleach. Reshape and dry flat. Cool iron if needed. Do not tumble dry.
              </p>
            </details>
              ...
              {tryOnStep === 'upload' && (
                <div className="p-6 sm:p-8">
                  ...
                  <div className="flex items-center gap-3 mb-6 p-3 bg-gray-50 rounded-lg">
                    <img src={productImage} alt="Product" className="w-14 h-14 object-cover rounded" />
                    <div>
                      <p className="text-[12px] font-medium">Fair Isle Knit Sweater</p>
                      <p className="text-[11px] text-gray-500">£295</p>
                    </div>
                  </div>
              ...
              {tryOnStep === 'result' && (
                <div className="p-6 sm:p-8">
                  <div className="text-center mb-4">
                    ...
                    <p className="text-[11px] text-gray-500">Fair Isle Knit Sweater — £295</p>
                  </div>
                  <div
...
export default ReallyWildDemoPage2;
