...
const ReallyWildDemoPage2: React.FC = () => {
  ...
  const productImages = ['/result-images/reallywild-3.png', '/result-images/reallywild-3.2.webp'];
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] xl:grid-cols-[1fr_460px] gap-6 lg:gap-12">
          ...
          <div className="flex flex-col lg:pt-0">
            ...
            {/* Price */}
            <div className="mb-6">
              <span className="text-[14px] font-medium">£540</span>
            </div>
                        ...
                        <div className="flex flex-col">
                          ...
                          <div className="flex-1 px-5 py-6 overflow-y-auto">
                            ...
                            <div className="mb-5">
                              ...
                              <label htmlFor="rw2-face-upload" className="block cursor-pointer">
                            ...
                            <div className="mb-5">
                              ...
                              <label htmlFor="rw2-body-upload" className="block cursor-pointer">
                                <div className={`relative border rounded-lg p-4 transition-colors ${
                    ...
                    >
                      <div className="p-6 sm:p-8">
                        ...
                        <div className="text-center mb-4">
                          ...
                          <p className="text-[11px] text-gray-500">Fair Isle Knit Sweater — £540</p>
                        </div>
                        <div
