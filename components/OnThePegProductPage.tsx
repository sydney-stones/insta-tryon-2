...
const OnThePegProductPage: React.FC<OnThePegProductPageProps> = ({ product, onTryOnClick }) => {
  ...
  const mainProduct = {
    ...
    price: 214.95,
    image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/OnthePegtrousers.png',
  ...
  const completeTheLookItems = [
    {
      ...
      price: 44.99,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/OnthePegshirt.png',
      shopUrl: 'https://go.shopmy.us/p-31548107',
    },
    {
      name: 'On The Peg Women\'s Baker Boy Hat',
      price: 90,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/OnthePeghat.png',
