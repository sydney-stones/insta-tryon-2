...
interface OnThePegProductPageProps {
  onTryOnClick: (product: WardrobeItem) => void;
}

const OnThePegProductPage: React.FC<OnThePegProductPageProps> = ({ onTryOnClick }) => {
  ...
  const completeTheLookItems = [
    ...
    },
    {
      ...
      price: 90,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/onthepeg-hat.png',
      shopUrl: 'https://go.shopmy.us/p-31548200',
    },
    {
      name: 'HOUSE OF CHEVIOT LADY RANNOCH SHOOTING SOCKS BILBERRY LARGE',
      price: 30,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/onthepeg-socks.png',
      shopUrl: 'https://go.shopmy.us/p-31548238',
    },
    {
      name: 'HERITAGE CALF LENGTH LEATHER BOOTS',
      price: 295,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/onthepeg-boots.png',
      ...
      {savedModel && selectedImageIndex === productMedia.length - (tryOnResult ? 2 : 1) && productMedia[selectedImageIndex]?.type === 'image' && (
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-xl sm:text-2xl mb-6">£{mainProduct.price.toFixed(2)}</p>
...
export default OnThePegProductPage;
