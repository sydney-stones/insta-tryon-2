...
interface BeaufortAndBlakeProductPageProps {
  product: WardrobeItem;
  onTryOnClick: (product: WardrobeItem) => void;
}

const BeaufortAndBlakeProductPage: React.FC<BeaufortAndBlakeProductPageProps> = ({ product, onTryOnClick }) => {
  ...
  const mainProduct = {
    ...
    price: 130,
    image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/beaufortandblake-jumper.png',
  ...
  const completeTheLookItems = [
    {
      ...
      price: 99,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/beaufortandblake-trousers.png',
      shopUrl: 'https://go.shopmy.us/p-31709335',
    },
    {
      name: 'Chocolate Brown Apron Derby Boot',
      price: 149,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/beaufortandblake-shoes.png',
...
export default BeaufortAndBlakeProductPage;
