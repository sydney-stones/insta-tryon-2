...
const comparisons: ComparisonCard[] = [
  { id: 1, productType: 'Summer Dress', beforeLabel: 'Customer Photo 1', productLabel: 'Product: Summer Dress', afterLabel: 'Try-On Result 1', beforeSrc: '', productSrc: '', afterSrc: '' },
  { id: 2, productType: 'Denim Jacket', beforeLabel: 'Customer Photo 2', productLabel: 'Product: Denim Jacket', afterLabel: 'Try-On Result 2', beforeSrc: '', productSrc: '', afterSrc: '' },
  { id: 3, productType: 'Evening Gown', beforeLabel: 'Customer Photo 3', productLabel: 'Product: Evening Gown', afterLabel: 'Try-On Result 3', beforeSrc: '', productSrc: '', afterSrc: '' },
  { id: 4, productType: 'Casual T-Shirt', beforeLabel: 'Customer Photo 4', productLabel: 'Product: Casual T-Shirt', afterLabel: 'Try-On Result 4', beforeSrc: '', productSrc: '', afterSrc: '' },
  { id: 5, productType: 'Wool Coat', beforeLabel: 'Customer Photo 5', productLabel: 'Product: Wool Coat', afterLabel: 'Try-On Result 5', beforeSrc: '', productSrc: '', afterSrc: '' },
  { id: 6, productType: 'Silk Blouse', beforeLabel: 'Customer Photo 6', productLabel: 'Product: Silk Blouse', afterLabel: 'Try-On Result 6', beforeSrc: '', productSrc: '', afterSrc: '' },
  { id: 7, productType: 'Leather Jacket', beforeLabel: 'Customer Photo 7', productLabel: 'Product: Leather Jacket', afterLabel: 'Try-On Result 7', beforeSrc: '', productSrc: '', afterSrc: '' },
