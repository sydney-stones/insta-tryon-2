...
interface NouvelleHabitProductPageProps {
  product: WardrobeItem;
  onTryOnClick: (product: WardrobeItem) => void;
}

const NouvelleHabitProductPage: React.FC<NouvelleHabitProductPageProps> = ({ product, onTryOnClick }) => {
  ...
  // Main product item (The Compass Habit)
  const mainProduct = {
    name: 'The Compass',
    price: 290,
    image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/nouvellehabit-habit.png',
  ...
  const completeTheLookItems = [
    {
      ...
      price: 131,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/nouvellehabit-top.png',
      shopUrl: 'https://go.shopmy.us/p-28478422',
    },
    {
      name: 'Merino Plain Shooting Socks',
      price: 59.95,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/nouvellehabit-socks.png',
      shopUrl: 'https://go.shopmy.us/p-28478566',
    },
    {
      name: 'Women\'s National Trust Vierzon Jersey Lined Wellington Boot - Oak Green',
      price: 220,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/nouvellehabit-wellies.png',
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6 lg:gap-8 text-xs lg:text-sm tracking-wide">
              <Link to="/" className="hover:opacity-60 transition-opacity">SHOOTING</Link>
              <Link to="/" className="hover:opacity-60 transition-opacity">COUNTRY</Link>
...
export default NouvelleHabitProductPage;
