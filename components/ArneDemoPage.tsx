...
/**
 * Standalone Arne demo pages — identical widget/workflow to ScabalDemoPage,
 * branded as Arne. Sydney (male) customer images for menswear, Sienna (female) for womenswear.
 */
...
export const ARNE_PRODUCTS: Record<string, DemoProduct> = {
  'menswear': {
    id: 30,
    name: 'Arne Jacket',
    brand: 'Arne',
    ...
    productLabel: 'Product: Arne Jacket',
    ...
    description: 'A refined jacket from Arne, crafted for the modern wardrobe. Clean lines and premium materials define this contemporary essential.',
  },
  'womenswear': {
    id: 31,
    name: 'Arne Womenswear',
    brand: 'Arne',
    price: 595,
    category: 'Clothing',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
...
interface ArneDemoPageProps {
  productSlug: keyof typeof ARNE_PRODUCTS;
}

const ArneDemoPage: React.FC<ArneDemoPageProps> = ({ productSlug }) => {
  const product = ARNE_PRODUCTS[productSlug];
