...
/**
 * Standalone Nation LTD (NationLA) demo page — pre-made example for sales calls.
...
export const NATIONLA_PRODUCTS: Record<string, DemoProduct> = {
  ...
  'lenon-sweatshirt': {
    ...
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    gallerySrcs: [
      '/result-images/NationLA/Lenon Sweatshirt/LENON_CREWNECK_SWEATSHIRT_2326D0FTH_HGR_LAUREN_S2.webp',
      '/result-images/NationLA/Lenon Sweatshirt/LENON_CREWNECK_SWEATSHIRT_2326D0FTH_HGR_LAUREN_S3.webp',
      '/result-images/NationLA/Lenon Sweatshirt/LENON_CREWNECK_SWEATSHIRT_2326D0FTH_HGR_YULIA_1.webp',
      '/result-images/NationLA/Lenon Sweatshirt/LENON_CREWNECK_SWEATSHIRT_2326D0FTH_HGR_YULIA_3.webp',
      '/result-images/NationLA/Lenon Sweatshirt/LENON_CREWNECK_SWEATSHIRT_2326D0FTH_HGR_YULIA_H4.webp',
    ],
    faceSrc: '/result-images/siennaface-new.png',
    bodySrc: '/result-images/siennabody--new.JPG',
...
interface NationLADemoPageProps {
  productSlug: keyof typeof NATIONLA_PRODUCTS;
}

const NationLADemoPage: React.FC<NationLADemoPageProps> = ({ productSlug }) => {
  const product = NATIONLA_PRODUCTS[productSlug];
      ...
      <header style={{ borderBottom: '1px solid #e5e5e5', position: 'sticky', top: 0, backgroundColor: '#fff', zIndex: 40 }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '60px' }}>
          <nav style={{ display: 'flex', gap: '24px', fontSize: '11px', letterSpacing: '0.15em', fontWeight: 500 }}>
            {['NEW IN','TOPS','BOTTOMS','DRESSES'].map(n => (
...
export default NationLADemoPage;
