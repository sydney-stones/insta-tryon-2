...
/**
 * Standalone Cernucci demo pages.
 * Widget and workflow identical to ScabalDemoPage / HollandHollandDemoPage template.
 * Product page styled to match Cernucci's website.
 * Animation starts on manual button click. Subtle skip link shown during animation.
 */
...
export const CERNUCCI_PRODUCTS: Record<string, DemoProduct> = {
  ...
  'cuban-chain': {
    id: 61,
    name: 'Cuban Chain - 8mm - White Gold',
    brand: 'Cernucci',
    price: '£74.99',
    colour: 'White Gold',
    sizes: ['18"', '20"', '22"', '24"', '26"'],
    defaultSize: '20"',
    productSrc: `${BASE}/cubanchain/YS-8MM-IOCC-WG_1200x1800.jpg.webp`,
    faceSrc: '/result-images/IMG_8175.jpeg',
    bodySrc: '/result-images/sydbody Background Removed.png',
    afterSrc: `${BASE}/cubanchain/YS-8MM-IOCC-WG_1200x1800.jpg-nb2-4k-tryon-2.png`,
    description: 'The 8mm Cuban Chain in White Gold is a bold statement piece. Precision-crafted links with a high-polish finish make this chain a flagship Cernucci product. Worn alone or layered — it dominates.',
    metal: 'Brass · 18k White Gold Plated · Tarnish Resistant',
  },
  'stud-earring': {
    id: 62,
    name: 'Iced Out Stud Earring - White Gold',
    brand: 'Cernucci',
    price: '£29.99',
    colour: 'White Gold',
    sizes: ['One Size'],
    defaultSize: 'One Size',
    productSrc: `${BASE}/studearring/ZH-ICSE-WG_9762a909-4c87-4abc-a44f-114569e7447d_1200x1800.jpg.webp`,
    faceSrc: '/result-images/IMG_8175.jpeg',
    bodySrc: '/result-images/sydbody Background Removed.png',
    afterSrc: `${BASE}/studearring/ZH-ICSE-WG_9762a909-4c87-4abc-a44f-114569e7447d_1200x1800.jpg-nb2-4k-tryon copy.png`,
    description: 'The Iced Out Stud Earring is encrusted with premium cubic zirconia for maximum sparkle. Lightweight and comfortable to wear all day, these studs add instant edge to any look.',
    metal: 'Brass · Rhodium Plated · CZ Stones',
  },
  'matching-set': {
    id: 63,
    name: 'Core Chocolate Matching Set',
    brand: 'Cernucci',
    price: '£89.99',
    colour: 'Chocolate',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    defaultSize: 'M',
    productSrc: `${BASE}/matchingset/corechocshort_zip-1_1200x1800.jpg.webp`,
    faceSrc: '/result-images/IMG_8175.jpeg',
    bodySrc: '/result-images/sydbody Background Removed.png',
    afterSrc: `${BASE}/matchingset/corechocshort_zip-1_1200x1800.jpg-nb2-4k-tryon.png`,
    description: 'The Core Chocolate Matching Set pairs a zip-through hoodie with co-ordinating shorts for an effortless athleisure look. Made from premium heavyweight fleece for a luxury feel.',
    metal: undefined,
  },
};
...
interface CernucciDemoPageProps {
  productSlug: keyof typeof CERNUCCI_PRODUCTS;
}

const CernucciDemoPage: React.FC<CernucciDemoPageProps> = ({ productSlug }) => {
  const product = CERNUCCI_PRODUCTS[productSlug];
    ...
    <div className="min-h-screen bg-white overflow-auto">
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '12px 24px' }}>
        <nav style={{ display: 'flex', gap: '6px', alignItems: 'center', fontSize: '12px', color: '#999' }}>
          ...
          <span>All Jewellery</span><span>/</span>
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 24px 64px', display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 480px', gap: isMobile ? '24px' : '48px', alignItems: 'start' }}>
        ...
        {/* Left — Main image */}
        <div style={{ backgroundColor: '#f5f5f5', aspectRatio: '2/3', overflow: 'hidden' }}>
          <img src={product.productSrc} alt={product.name} style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
        </div>
        ...
        <div style={{ paddingTop: '8px' }}>
          ...
          {product.sizes.length > 1 && (
            <div style={{ marginBottom: '20px' }}>
              ...
              <p style={{ fontSize: '12px', color: '#666', margin: '6px 0 0 0' }}>Model wears size {product.defaultSize}.</p>
            </div>
          )}

          {/* AI TRY ON — primary CTA */}
          <button
            ref={tryOnButtonRef}
...
export default CernucciDemoPage;
