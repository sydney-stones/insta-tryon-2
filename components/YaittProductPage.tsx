...
const YaittProductPage: React.FC<YaittProductPageProps> = ({ product, onTryOnClick }) => {
  ...
  const mainProduct = {
    ...
    price: 225,
    image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Yaitteshirt.png',
  ...
  const completeTheLookItems = [
    {
      ...
      price: 225,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Yaittetrousers.png',
      shopUrl: 'https://go.shopmy.us/p-31581310',
    },
    {
      name: 'Arizona PROF',
      price: 80,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Yaitteshoes.png',
