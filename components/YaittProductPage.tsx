...
interface YaittProductPageProps {
  onTryOnClick: (product: WardrobeItem) => void;
}

const YaittProductPage: React.FC<YaittProductPageProps> = ({ onTryOnClick }) => {
  ...
  const demoProduct: WardrobeItem = useMemo(() => ({
    ...
    folder: 'Demo',
    price: 225,
    description: 'Oversized ice grey plaid flannel shirt with a relaxed fit. Perfect for casual everyday wear.',
    collection: 'Demo',
  ...
  // Main product item (Shirt)
  const mainProduct = {
    name: 'BRAEMAR - Oversized Ice Grey Plaid Flannel Shirt',
    price: 225,
    image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/yaitt-shirt.png',
    shopUrl: 'https://go.shopmy.us/p-31547859',
  };
  ...
  const completeTheLookItems = [
    {
      name: 'Logo Crew Sock',
      price: 20,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/yaitt-sock1.png',
      shopUrl: 'https://go.shopmy.us/p-31547914',
    },
    {
      name: 'Bella Patch Pocket Wide Leg Jeans in Mid Blue',
      price: 170,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/yaitt-trousers.png',
      shopUrl: 'https://go.shopmy.us/p-31547944',
    },
    {
      name: 'Carmen Rib-Knit Socks With Cashmere in Grey',
      price: 18,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/yaitt-sock2.png',
      shopUrl: 'https://go.shopmy.us/p-31547969',
    },
    {
      name: 'GEL-1130',
      price: 95,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/yaitt-shoes.png',
          ...
          <div className="flex flex-col">
            ...
            <div className="border-t pt-6 mb-6">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Complete your casual style with these perfectly matched pieces
              </p>
...
export default YaittProductPage;
