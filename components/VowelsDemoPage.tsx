 ...
 * Cézanne Zip-Up Jacket uses Sydney images; Overdyed Painter Pants uses Sienna images.
 */
...
export const VOWELS_PRODUCTS: Record<string, DemoProduct> = {
  'cezanne-zip-up-jacket': {
    ...
    category: 'Jackets',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    productSrc: '/result-images/vowels4.jpg',
    productLabel: 'Product: Cézanne Zip-Up Jacket',
  ...
  'overdyed-painter-pants': {
    ...
    category: 'Trousers',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    productSrc: '/result-images/vowels1.jpg',
    productLabel: 'Product: Overdyed Painter Pants',
...
const VowelsDemoPage: React.FC<VowelsDemoPageProps> = ({ productSlug }) => {
  ...
  return (
    <div className="min-h-screen bg-white overflow-auto">
      ...
      {/* Store Header — branded as Vowels */}
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14">
            <nav className="hidden md:flex items-center gap-6 text-[11px] tracking-[0.15em] font-medium">
              ...
              <span className="text-gray-400">BOTTOMS</span>
              <span className="text-gray-400">OUTERWEAR</span>
            </nav>
            <span className="absolute left-1/2 transform -translate-x-1/2 text-lg sm:text-xl tracking-[0.12em] font-light text-gray-900">
              VOWELS
            </span>
