...
const EmiliaWicksteadProductPage: React.FC<EmiliaWicksteadProductPageProps> = ({ product, onTryOnClick }) => {
  ...
  const completeTheLookItems = [
    ...
    {
      name: 'Tank Louis Cartier Automatic Watch',
      brand: 'Cartier',
      price: 12800,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Festival_Of_Fashion/FOF-individualitems/EmiliaWickstead/Cartier-TankLouisCartierautomatic25.5mm18-karatgoldandalligator watch.png',
      shopUrl: 'https://go.shopmy.us/p-28351271',
      isEmiliaWickstead: false,
      affiliateCommission: 1280
    },
    {
      name: 'Chakra Gold Garnet Earrings',
      brand: 'Jia Jia',
      price: 975,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Festival_Of_Fashion/FOF-individualitems/EmiliaWickstead/JiaJia-Chakragoldgarnetearrings.png',
      shopUrl: 'https://go.shopmy.us/p-28351287',
      isEmiliaWickstead: false,
      affiliateCommission: 98
    }
  ];
                  ...
                  <div key={index} className="group">
                    <a href={item.shopUrl} target="_blank" rel="noopener noreferrer" className="block relative">
                      <div className="relative aspect-[3/4] bg-gray-100 rounded-sm overflow-hidden mb-2">
                        ...
                        {!item.isEmiliaWickstead && item.affiliateCommission && (
                        ...
                        {!item.isEmiliaWickstead && item.brand && (
