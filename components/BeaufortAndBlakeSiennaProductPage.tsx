...
interface BeaufortAndBlakeSiennaProductPageProps {
  product: WardrobeItem;
  onTryOnClick: (product: WardrobeItem) => void;
}

const BeaufortAndBlakeSiennaProductPage: React.FC<BeaufortAndBlakeSiennaProductPageProps> = ({ product, onTryOnClick }) => {
...
export default BeaufortAndBlakeSiennaProductPage;
