...
export const HH_PRODUCTS: Record<string, HHProduct> = {
  'tweed-field-coat': {
    ...
    productImages: [
      `${BASE}/NORTHWOOD TWEED FIELD COAT/clo-fldcoat1hawthorn-frontcopy_377520b7-af93-4b2a-baa4-a0ab41ac4011_2000x.jpg`,
      `${BASE}/NORTHWOOD TWEED FIELD COAT/clo-fldcoat1hawthorn-backcopy_1c6442ea-53a5-4063-801f-83f748e78e65_2000x.jpg`,
      `${BASE}/NORTHWOOD TWEED FIELD COAT/clo-fldcoat1hawthorn-detailcopy_8213dca1-99de-471c-90e2-c0be7caa2bf1_2000x.jpg`,
    ],
    faceSrc: '/result-images/IMG_8175.jpeg',
    bodySrc: '/result-images/sydbody Background Removed.png',
    afterSrc: `${BASE}/NORTHWOOD TWEED FIELD COAT/clo-fldcoat1hawthorn-backcopy_1c6442ea-53a5-4063-801f-83f748e78e65_2000x-nb2-2k-tryon.png`,
  },
  'shooting-gilet': {
    id: 51,
    ...
    productImages: [
      `${BASE}/NORTHWOOD SHOOTING GILET/CLO-SWEATER5GiletMoss1_3559071e-b608-4b11-b3c8-2fbee352c3ee_2000x.jpg`,
      `${BASE}/NORTHWOOD SHOOTING GILET/CLO-SWEATER5GiletMoss2_d8686d3f-f6d2-4d1f-b093-8762682eb181_2000x.jpg`,
      `${BASE}/NORTHWOOD SHOOTING GILET/CLO-SWEATER5GiletMoss4_b5e144c0-93cb-4f30-a8e2-c3edc2c146b4_2000x.jpg`,
    ],
    faceSrc: '/result-images/IMG_8175.jpeg',
    bodySrc: '/result-images/sydbody Background Removed.png',
    afterSrc: `${BASE}/NORTHWOOD SHOOTING GILET/CLO-SWEATER5GiletMoss1_3559071e-b608-4b11-b3c8-2fbee352c3ee_2000x-nb2-2k-tryon.png`,
  },
  'ladies-shirt': {
    id: 52,
    name: 'NORTHWOOD LADIES BRUSHED COTTON SHIRT',
    price: '£275.00',
    colour: 'HEATHER',
    category: 'Ladies',
    sizes: ['6', '8', '10', '12', '14', '16'],
    description: 'A refined ladies shirt in soft brushed cotton, cut for a relaxed but polished fit. Ideal for the field or countryside, this versatile piece pairs seamlessly with tweed and knitwear.',
    productImages: [
      `${BASE}/NORTHWOOD LADIES BRUSHED COTTON SHIRT/CLO-LSHIRT1Heather1_1638e6c1-5781-4e8a-81c1-728e3079b313_2000x.jpg`,
      `${BASE}/NORTHWOOD LADIES BRUSHED COTTON SHIRT/CLO-LSHIRT1Heather2_2238ca49-1cb2-4ed3-b8a9-7497aa5efd44_2000x.jpg`,
      `${BASE}/NORTHWOOD LADIES BRUSHED COTTON SHIRT/CLO-LSHIRT1Heather4_cc83f8b7-fcd5-486c-ab2f-c7653aabb7e7_2000x.jpg`,
    ],
    faceSrc: '/result-images/siennaface-new.png',
    bodySrc: '/result-images/siennaneutral--new.JPG',
    afterSrc: `${BASE}/NORTHWOOD LADIES BRUSHED COTTON SHIRT/CLO-LSHIRT1Heather1_1638e6c1-5781-4e8a-81c1-728e3079b313_2000x.jpg-nb2-2k-tryon.png`,
  },
  'tweed-cap': {
    id: 53,
    ...
    productImages: [
      `${BASE}/HARROW TWEED PANEL CAP/CLO-CAP2HONEYSUCKLE1_bd7c83e1-f236-4582-a0ff-230af9275c94_2000x.jpg`,
      `${BASE}/HARROW TWEED PANEL CAP/CLO-CAP2HONEYSUCKLE2_c1db3b89-ed35-4efb-90b5-25c113ebc4a0_2000x.jpg`,
      `${BASE}/HARROW TWEED PANEL CAP/CLO-CAP2HONEYSUCKLE3_803857ee-98b1-4b02-844a-21b79cc2f051_2000x.jpg`,
    ],
    faceSrc: '/result-images/IMG_8175.jpeg',
    bodySrc: '/result-images/sydbody Background Removed.png',
    afterSrc: `${BASE}/HARROW TWEED PANEL CAP/CLO-CAP2HONEYSUCKLE1_bd7c83e1-f236-4582-a0ff-230af9275c94_2000x.jpg-nb2-2k-tryon.png`,
  },
};
