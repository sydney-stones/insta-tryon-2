...
/**
 * Standalone Slowlove Knitwear demo page — pre-made example for sales calls.
...
export const SLOWLOVE_PRODUCTS: Record<string, DemoProduct> = {
  'spaced-out-hand-knit-jumper': {
    id: 110,
    name: 'Spaced Out Hand Knit Jumper',
    brand: 'SLOWLOVE KNITWEAR',
    price: '£295.00',
    category: 'Knitwear',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    gallerySrcs: [
      '/result-images/slowlove/spaced out/spaced-out-hand-knit-jumper-front_2048x2048.webp',
      '/result-images/slowlove/spaced out/spaced-out-hand-knit-jumper-closeup-texture_2048x2048.webp',
      '/result-images/slowlove/spaced out/spaced-out-hand-knit-jumper-motif-detail_2048x2048.webp',
    ],
    faceSrc: '/result-images/siennaface-new.png',
    bodySrc: '/result-images/siennabody--new.JPG',
    afterSrc: '/result-images/slowlove/spaced out/ChatGPT Image Apr 24, 2026, 09_12_07 AM.png',
    description: 'The Spaced Out Hand Knit Jumper. Each one hand-knitted, no two exactly alike — open-stitch construction with a considered, artisan quality that mass production can\'t replicate.',
    colourLabel: 'Natural',
    swatchColor: '#E8DCC8',
  },
  'staple-cardigan-panna-cotta': {
    id: 111,
    name: 'The Staple Cardigan - Panna Cotta',
    brand: 'SLOWLOVE KNITWEAR',
    price: '£180.00',
    category: 'Knitwear',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    gallerySrcs: [
      '/result-images/slowlove/staple cardigan/staple-cardigan-panna-cotta-model-front_2048x2048.jpg',
      '/result-images/slowlove/staple cardigan/staple-cardigan-panna-cotta-side-view_2048x2048.jpg',
      '/result-images/slowlove/staple cardigan/staple-cardigan-panna-cotta-close-up-knit_2048x2048.jpg',
    ],
    faceSrc: '/result-images/siennaface-new.png',
    bodySrc: '/result-images/siennabody--new.JPG',
    afterSrc: '/result-images/slowlove/staple cardigan/95d079c4-40e1-4e73-ab88-5a5176037eec.png',
    description: 'The Staple Cardigan in Panna Cotta. A foundational knit in a warm, creamy neutral — the piece you layer over everything and reach for without thinking.',
    colourLabel: 'Panna Cotta',
    swatchColor: '#F0E4D0',
  },
  'neon-butterfly-hand-knit-jumper': {
    id: 112,
    name: 'Neon Butterfly Hand Knit Jumper',
    brand: 'SLOWLOVE KNITWEAR',
    price: '£295.00',
    category: 'Knitwear',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    gallerySrcs: [
      '/result-images/slowlove/butterfly/HeidiJonesxSlowLove-1_2048x2048.webp',
      '/result-images/slowlove/butterfly/HeidiJonesxSlowLove-2_2048x2048.webp',
      '/result-images/slowlove/butterfly/HeidiJonesxSlowLove-085_2048x2048.webp',
    ],
    faceSrc: '/result-images/siennaface-new.png',
    bodySrc: '/result-images/siennabody--new.JPG',
    afterSrc: '/result-images/slowlove/butterfly/HeidiJonesxSlowLove-1_2048x2048_HeidiJonesxSlowLove-2_2048x2048_HeidiJonesxSlowLove-085_2048x2048.jpeg',
    description: 'The Neon Butterfly Hand Knit Jumper. A collaboration piece with Heidi Jones — hand-knitted intarsia butterfly motifs in vivid, saturated colour. Wearable art.',
    colourLabel: 'Neon Multi',
    swatchColor: '#E040FB',
  },
};
...
interface SlowloveDemoPageProps { productSlug: keyof typeof SLOWLOVE_PRODUCTS; }

const SlowloveDemoPage: React.FC<SlowloveDemoPageProps> = ({ productSlug }) => {
  const product = SLOWLOVE_PRODUCTS[productSlug];
      ...
      <header style={{ borderBottom: '1px solid #e5e5e5', position: 'sticky', top: 0, backgroundColor: '#fff', zIndex: 40 }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '60px' }}>
          <nav style={{ display: 'flex', gap: '24px', fontSize: '11px', letterSpacing: '0.15em', fontWeight: 500 }}>
            {['NEW IN','JUMPERS','CARDIGANS','ACCESSORIES'].map(n => <span key={n} style={{ color: '#aaa' }}>{n}</span>)}
          </nav>
          <span style={{ position: 'absolute', left: '50%', transform: 'translateX(-50%)', fontSize: '20px', fontWeight: 300, letterSpacing: '0.08em', color: '#111' }}>SLOWLOVE</span>
          <div />
        </div>
      </header>
...
export default SlowloveDemoPage;
