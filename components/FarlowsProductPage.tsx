...
interface FarlowsProductPageProps {
  product: WardrobeItem;
  onTryOnClick: (product: WardrobeItem) => void;
}

const FarlowsProductPage: React.FC<FarlowsProductPageProps> = ({ product, onTryOnClick }) => {
  ...
  const mainProduct = {
    ...
    price: 750,
    image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/farlows-jacket.png',
  ...
  const completeTheLookItems = [
    {
      ...
      price: 220,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/farlows-trousers.png',
      shopUrl: 'https://go.shopmy.us/p-31709255',
    },
    {
      name: 'FARLOWS CLASSIC 8 PIECE TWEED HAT',
      price: 80,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/farlows-hat.png',
      shopUrl: 'https://go.shopmy.us/p-31709270',
    },
    {
      name: 'WOMEN\'S VIERZON JERSEY LINED WELLINGTON BOOT',
      price: 180,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/farlows-shoes.png',
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6 lg:gap-8 text-xs lg:text-sm tracking-wide">
              ...
              <Link to="/" className="hover:opacity-60 transition-opacity">FISHING</Link>
...
export default FarlowsProductPage;
