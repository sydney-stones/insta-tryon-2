...
interface MaisonSchiaparelliProductPageProps {
  product: WardrobeItem;
  onTryOnClick: (product: WardrobeItem) => void;
}

const MaisonSchiaparelliProductPage: React.FC<MaisonSchiaparelliProductPageProps> = ({ product, onTryOnClick }) => {
  ...
  // Main product item (Cardigan/Top)
  const mainProduct = {
    name: 'Snake Scale Trompe L\'Oeil Cardigan',
    price: 4345.09,
    image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Festival_Of_Fashion/FOF-individualitems/Maison Schiaparelli/MaisonSchiaparellitop.png',
    shopUrl: 'https://go.shopmy.us/p-28554672',
    isMaisonSchiaparelli: true
  };
  ...
  const completeTheLookItems = [
    {
      ...
      price: 4343.02,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Festival_Of_Fashion/FOF-individualitems/Maison Schiaparelli/MaisonSchiaparellitoursers.png',
    ...
    },
    {
      name: 'Eyes Earrings',
      price: 1042.26,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Festival_Of_Fashion/FOF-individualitems/Maison Schiaparelli/MaisonSchiaparelliearrings.png',
    ...
    },
    {
      ...
      price: 1650.05,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Festival_Of_Fashion/FOF-individualitems/Maison Schiaparelli/MaisonSchiaparelliheels.png',
    ...
    },
    {
      ...
      price: 11291.15,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/Festival_Of_Fashion/FOF-individualitems/Maison Schiaparelli/MaisonSchiaparellibag.png',
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6 lg:gap-8 text-xs lg:text-sm tracking-wide">
              <Link to="/" className="hover:opacity-60 transition-opacity">HAUTE COUTURE</Link>
      ...
      {savedModel && selectedImageIndex === productMedia.length - (tryOnResult ? 2 : 1) && productMedia[selectedImageIndex]?.type === 'image' && (
        ...
        {/* ROI CALCULATOR */}
        <ROICalculator defaultRevenue={600000} />
      </div>
...
export default MaisonSchiaparelliProductPage;
