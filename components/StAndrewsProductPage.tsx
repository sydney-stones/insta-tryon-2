...
interface StAndrewsProductPageProps {
  product: WardrobeItem;
  onTryOnClick: (product: WardrobeItem) => void;
}

const StAndrewsProductPage: React.FC<StAndrewsProductPageProps> = ({ product, onTryOnClick }) => {
  ...
  // Main product item (Hoodie)
  const mainProduct = {
    name: 'SCUBA OVERSIZED HALF-ZIP HOODIE',
    price: 116,
    image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/standrews-hoodie.png',
  ...
  const completeTheLookItems = [
    {
      ...
      price: 56,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/standrews-shorts.png',
      shopUrl: 'https://go.shopmy.us/p-31708934',
    },
    {
      name: 'Clifton 9',
      price: 130,
      image: 'https://raw.githubusercontent.com/sydney-stones/insta-tryon-2/main/outfits/standrews-trainers.png',
...
export default StAndrewsProductPage;
